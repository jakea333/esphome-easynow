...
namespace esphome
{
  namespace ripnetuk_neopixel
  {
    ...
    void RipnetUkNeopixelComponent::draw()
    {
    ...
    int RipnetUkNeopixelComponent::scaleToByte(double value, double brightness)
    {
    ...
    void RipnetUkNeopixelComponent::showPixels()
    {
    ...
    void RipnetUkNeopixelComponent::drawHoldingPattern()
    {
    ...
    void RipnetUkNeopixelComponent::drawOutOfRange(RGB rgb)
    {
    ...
    void RipnetUkNeopixelComponent::drawPower(float power)
    {
