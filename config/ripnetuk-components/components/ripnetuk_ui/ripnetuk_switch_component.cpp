...
namespace esphome
{
  namespace ripnetuk_ui
  {
    ...
    bool RipnetUkSwitchComponent::assumed_state() { return this->assumed_state_; }
    void RipnetUkSwitchComponent::set_state_lambda(std::function<optional<bool>()> &&f) { this->f_ = f; }
    float RipnetUkSwitchComponent::get_setup_priority() const { return setup_priority::HARDWARE; }
