...
```
cd existing_repo
git remote add origin https://gitlab.com/ripnetuk-root/ripnetuk-microcontroller/test-esp32.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ripnetuk-root/ripnetuk-microcontroller/test-esp32/-/settings/integrations)
