...
DEPENDENCIES = ['logger', 'ripnetuk_lightshow_core', 'ripnetuk_ui', "spi", 'display']
AUTO_LOAD = ['ripnetuk_ui', 'ili9341', 'display']
...
ns = cg.esphome_ns.namespace('ripnetuk_lightshow_output_lcd')
RipnetUkLightshowOutputLcdComponent = ns.class_(
    'RipnetUkLightshowOutputLcdComponent', cg.Component, spi.SPIDevice, display.DisplayBuffer, BaseRipnetUkLightshowOutputComponent)
...
CONFIG_SCHEMA = cv.All(
    display.FULL_DISPLAY_SCHEMA.extend(
        {
            cv.GenerateID(): cv.declare_id(RipnetUkLightshowOutputLcdComponent),
